                                ...
                                content: SingleChildScrollView(
                                  child: Column(
                                    ...
                                    children: const [
                                      ...
                                      SizedBox(height: 8),
                                      Text('• Adicionar/editar animais: use o botão "Adicionar animal" para publicar um novo anúncio. Em cada cartão pode editar ou apagar o anúncio.'),
                                      Text('• Media: adicione fotos e vídeos para melhorar o anúncio. Suportamos imagens e vídeos curtos.'),
                                      Text('• Mensagens: as mensagens chegadas são mostradas na secção de mensagens; responda para combinar visitas ou fornecer mais informações.'),
                                      SizedBox(height: 8),
                                      Text('• Favoritos: os utilizadores podem favoritar animais; veja essas interacções para priorizar contactos.'),
                                      SizedBox(height: 8),
                                      Text('• Perfil da instituição: atualize morada, horários e contactos em "Detalhes" para que os utilizadores vejam as informações corretas.'),
                                      SizedBox(height: 8),
                                      Text('• Apagar conta: se precisar de apagar a conta, contacte o suporte ou siga a opção de eliminação disponível nas definições de conta (esta ação remove os registos associados).'),
                                    ],
                                  ),
                                ),
